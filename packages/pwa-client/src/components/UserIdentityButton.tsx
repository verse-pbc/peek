...
export const UserIdentityButton: React.FC = () => {
  ...
  const handleImport = async (nsec: string, shouldMigrate: boolean = true) => {
    ...
    try {
      ...
      // NEVER log secretKey! Only log safe public information
      console.log('[UserIdentityButton] New identity:', {
        publicKey: newIdentity.publicKey.slice(0, 8) + '...',
        npub: newIdentity.npub,
        isAutoGenerated: newIdentity.isAutoGenerated
      });
