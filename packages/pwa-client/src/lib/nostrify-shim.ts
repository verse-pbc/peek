...
interface StoredIdentity {
  ...
  npub: string;
  isAutoGenerated: boolean; // true for auto-generated identities (created by Peek)
  ...
  React.useEffect(() => {
    ...
    if (stored) {
      try {
        ...
        // Migrate old identities without isAutoGenerated flag
        if (parsed.isAutoGenerated === undefined) {
          const migrated = { ...parsed, isAutoGenerated: false };
          localStorage.setItem(STORAGE_KEY, JSON.stringify(migrated));
          console.log('Migrated identity to include isAutoGenerated flag');
