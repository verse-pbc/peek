...
describe('Identity Migration Functionality', () => {
  ...
  describe('Auto-generated Identity Creation', () => {
    it('should create identity with isAnonymous flag', () => {
  ...
  describe('Identity Storage', () => {
    it('should switch from anonymous to real identity', () => {
      // Verify anonymous identity exists (unified storage)
      const anonStored = JSON.parse(localStorage.getItem('peek_nostr_identity') || '{}');
      expect(anonStored.isAnonymous).toBe(true);
      ...
      // Verify switch (same key, different isAnonymous flag)
      const stored = JSON.parse(localStorage.getItem('peek_nostr_identity') || '{}');
